    ...
    <Container className="py-12 md:py-16">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-lg text-zinc-600">
          Hand-picked product launches, research breakthroughs and practical
          stories, summarized for busy teams.
        </p>
      </div>
      ...
      {articles.length > 0 ? (
        ...
        <EmptyState
          ...
          description="We haven't published stories in this category yet. Check back soon."
        />
      )}
    </Container>
  );
